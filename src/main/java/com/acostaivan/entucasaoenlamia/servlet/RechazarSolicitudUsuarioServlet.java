...
@WebServlet("/usuario/rechazarSolicitud")
public class RechazarSolicitudUsuarioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        solicitudDAO.eliminar(solicitudId);
        resp.sendRedirect(req.getContextPath() + "/usuario/misEspacios?exito=rechazada");
    }
}